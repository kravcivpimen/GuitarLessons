// src/lib.rs
/*
 * Core library for GuitarLessons
 */
...
#[derive(Debug)]
pub struct GuitarLessonsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GuitarLessonsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GuitarLessons processing");
    
    let mut processor = GuitarLessonsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GuitarLessonsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GuitarLessonsProcessor::new(false);
